package br.com.avf.microservices.payroll.kafka.config;
...
import static br.com.avf.microservices.payroll.kafka.constant.ApplicationConstants.GROUP_ID_JSON;
import static br.com.avf.microservices.payroll.kafka.constant.ApplicationConstants.KAFKA_LOCAL_SERVER_CONFIG;
...
public class SpringKafkaConfiguration {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        configMap.put(GROUP_ID_CONFIG, GROUP_ID_JSON);
        configMap.put(TRUSTED_PACKAGES, "*");
        return new DefaultKafkaConsumerFactory<>(configMap);
    }
    //ConcurrentKafkaListenerContainerFactory
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Worker> kafkaListenerContainerFactory() {
        var factory = new ConcurrentKafkaListenerContainerFactory<String, Worker>();
